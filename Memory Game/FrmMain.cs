...
namespace Memory_Game
{
    public partial class FrmMain : Form
    {
        ...
        {
            //Thông tin về game
            MessageBox.Show("Đây là Trò chơi Lật thẻ được viết theo đề tài môn LTGD."
            + "\nGiảng viên hướng dẫn: Nguyễn Thị Phương Trang.\nĐề tài : Thực hiện project game Lật thẻ.\nThực hiện:\nTrần Thị Hoài Thương-1851050143\n"
             + "Khoa Công nghệ Thông tin\n"
            + "Trường Đại học Mở Thành phố Hồ Chí Minh.\n");
        }
